...
//6770099d-9ae2-3c3e-8c14-272f8c9c3e92
    ...
    public static void saveUserAvatar(String s, String nickname){
        try {
            ...
            if (check) {
                ...
                try {
                    ImageIO.write(img, "png", new File("infinityloop/temp/heads/" + nickname + ".png"));
                } catch (IOException e) {
    ...
    public static void savePlayerSkin(String s, String nickname){
        try {
            ...
            if (check) {
                ...
                try {
                    ImageIO.write(img, "png", new File("infinityloop/temp/skins/" + nickname + ".png"));
                } catch (IOException e) {
                    System.out.println("Couldn't create/send the output image.");
                    e.printStackTrace();
                }
    ...
    public static void syncCapes(){
        ...
        (new Thread(() -> {
            try {
                File tmp = new File("infinityloop" + File.separator + "temp" + File.separator +   "capes");
                if (!tmp.exists()) {
                    tmp.mkdirs();
                }
                ...
                while ((inputLine = in.readLine()) != null) {
                    ...
                    ImageIO.write(capeImage, "png", new File("infinityloop/temp/capes/" + name + ".png"));
