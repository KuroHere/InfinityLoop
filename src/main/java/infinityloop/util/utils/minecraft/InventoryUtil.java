...
public class InventoryUtil
    ...
    public enum The_Item
    {
        Obsidian,
        Chest;

        public static The_Item[] $VALUES;

        static {
            The_Item.$VALUES = new The_Item[] { The_Item.Obsidian, The_Item.Chest };
        }
    }
    ...
    public enum Switch {
        ...
        static {
            Switch.$VALUES = new Switch[] { Switch.NORMAL, Switch.SILENT, Switch.NONE };
        }
