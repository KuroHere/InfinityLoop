...
import infinityloop.features.modules.client.GameChanger;
...
public class RotationUtil
    ...
    public static boolean isInFov(Vec3d vec3d, Vec3d other) {
        ...
        float fov = (GameChanger.getInstance().customFov.getValue() ? GameChanger.getInstance().fov.getValue().floatValue() : mc.gameSettings.fovSetting) / 2.0f;
        return angle < fov + 10.0f && angle > -fov - 10.0f;
    }

    public static float getFov() {
        return GameChanger.getInstance().customFov.getValue() ? GameChanger.getInstance().fov.getValue().floatValue() : mc.gameSettings.fovSetting;
    }
