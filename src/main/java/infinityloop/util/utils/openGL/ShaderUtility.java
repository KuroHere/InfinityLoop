package infinityloop.util.utils.openGL;
...
public class ShaderUtility implements MixinInterface {
    public static ShaderUtility shader = new ShaderUtility("infinityloop/shaders/white.frag");
    ...
    public ShaderUtility(String fragmentShaderLoc) {
        this(fragmentShaderLoc, "minecraft/textures/vertex.vsh");
    }
