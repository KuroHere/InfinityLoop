package infinityloop.features.gui.mainmenu.alts;

import infinityloop.InfinityLoop;
import infinityloop.features.gui.font.FontRender;
import infinityloop.util.utils.Util;
import infinityloop.util.utils.renders.helper.RoundedShader;
import infinityloop.util.utils.renders.shaders.PNGtoResourceLocation;
...
public class AltCompoment {
    ...
    public void render(int mouseX, int mouseY){
        ...
        RoundedShader.drawRound(posX + 165, posY + 5, 35,  12, 3f, isHoveringLoggin(mouseX,mouseY) ? new Color(0xCB00FF04, true) : new Color(0x813EFF00, true));
        FontRender.drawCentString6("login", posX + 182.5f, posY + 10, isHoveringLoggin(mouseX,mouseY) ? new Color(0x7A7A7A).getRGB() : -1 );

        RoundedShader.drawRound(posX + 165, posY + 22, 35,  12, 3f, isHoveringDelete(mouseX,mouseY) ? new Color(0xE6FF0000, true) : new Color(0x81F60202, true));
        FontRender.drawCentString6("delete", posX + 182.5f, posY + 27, isHoveringDelete(mouseX,mouseY) ? new Color(0x7A7A7A).getRGB() : -1 );
