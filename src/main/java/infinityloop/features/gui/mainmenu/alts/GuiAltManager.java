...
import infinityloop.features.gui.mainmenu.GuiMainMenuButton;
import infinityloop.features.gui.mainmenu.InfinityLoopMenu;
import infinityloop.features.gui.mainmenu.MainMenuShader;
import infinityloop.features.modules.client.MainSettings;
...
import static infinityloop.InfinityLoop.alts;
import static infinityloop.features.gui.components.items.buttons.StringButton.removeLastChar;
...
public class GuiAltManager extends GuiScreen
{
    ...
    public void mouseClicked(int x,int y, int button){
        ...
        if (x >= sr.getScaledWidth() / 2 - 120 && x <= sr.getScaledWidth() / 2 + 102 && y >= sr.getScaledHeight() - 96 && y <= sr.getScaledHeight() - 61) {
            this.mc.displayGuiScreen(new InfinityLoopMenu());
        }
    }
