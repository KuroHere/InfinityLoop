...
import infinityloop.features.modules.client.ClickGui.ClickEnum;
...
public class ModuleButton
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (!this.items.isEmpty()) {
            ...
            } else if (ClickGui.getInstance().butonIcon.getValue() == ClickEnum.Icon.ShowBind) {
            ...
            if (this.isHovering(mouseX, mouseY)) {
                if (ClickGui.getInstance().description.getValue() == ClickEnum.Mode.Frame) {
                ...
                } else if (ClickGui.getInstance().description.getValue() == ClickEnum.Mode.Folow) {
