package infinityloop.features.gui.screen.windows;
...
import infinityloop.features.gui.screen.windows.window.WindowConfig;
import infinityloop.features.gui.screen.windows.window.WindowFriends;
import infinityloop.features.gui.screen.windows.window.WindowPackets;
import infinityloop.features.gui.screen.windows.window.WindowAltManager;
import infinityloop.features.modules.client.ClickGui.ClickGui;
import infinityloop.features.modules.client.Colors;
import infinityloop.features.modules.client.Windows;
