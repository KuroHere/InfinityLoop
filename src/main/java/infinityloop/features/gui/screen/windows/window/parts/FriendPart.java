package infinityloop.features.gui.screen.windows.window.parts;
...
import static infinityloop.util.utils.renders.RenderUtil.drawCompleteImage;
import static infinityloop.util.utils.renders.RenderUtil.drawImage;
