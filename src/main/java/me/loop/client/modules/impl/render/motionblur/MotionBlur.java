package me.loop.client.modules.impl.render.motionblur;
...
public class MotionBlur
    ...
    public void onClientTick(final TickEvent.ClientTickEvent event) {
        ...
        if (this.Setup) {
            MotionBlur.mc.entityRenderer.loadShader(new ResourceLocation("minecraft:shaders/post/lunar_motionblur.json"));
