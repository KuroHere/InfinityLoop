...
public class Replenish
        extends Module {
    private final Setting<Integer> delay = this.add(new Setting<Integer>("Delay", 0, 0, 10));
    private final Setting<Integer> gapStack = this.add(new Setting<Integer>("GapStack", 1, 50, 64));
    private final Setting<Integer> xpStackAt = this.add(new Setting<Integer>("XPStack", 1, 50, 64));
    private final Timer timer = new Timer();
    private final ArrayList<Item> Hotbar = new ArrayList();

    public Replenish() {
        super("Replenish", "Replenishes your hotbar", Category.PLAYER, true, false, false);
    }
