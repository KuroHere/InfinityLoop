...
public class Colors extends Module {
    ...
    public Setting<Integer> red = this.add(new Setting<Object>("Red", Integer.valueOf(230), Integer.valueOf(0), Integer.valueOf(255), v -> !this.rainbow.getValue()));
    public Setting<Integer> green = this.add(new Setting<Object>("Green", Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(255), v -> !this.rainbow.getValue()));
    public Setting<Integer> blue = this.add(new Setting<Object>("Blue", Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(255), v -> !this.rainbow.getValue()));
    public Setting<Integer> alpha = this.add(new Setting<Object>("Alpha", Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(255), v -> !this.rainbow.getValue()));
    public float hue;
