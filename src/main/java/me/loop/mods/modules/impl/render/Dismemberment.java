...
import me.loop.api.utils.impl.renders.helper.dism.ParticleBlood;
...
public class Dismemberment extends Module {
    ...
    public Setting<Boolean> blood = this.add(new Setting<Boolean>("Blood", false));
    public Setting<Integer> gibGroundTime = this.add(new Setting<Integer>("OnGroundTime", 425, 0, 2000));
    public Setting<Integer> gibTime = this.add(new Setting<Integer>("LiveTime", 425, 0, 2000));
    public Setting<Integer> bcount = this.add(new Setting<Integer>("BloodCount", 425, 0, 2000));
    ...
    public Dismemberment() {
        super("Dismemberment", "Bloody", Category.RENDER, true, false);
    }
