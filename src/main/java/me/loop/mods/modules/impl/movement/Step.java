...
import me.loop.api.events.impl.network.StepEvent;
...
public class Step
        extends Module {
    public Setting<Boolean> vanilla = this.add(new Setting<Boolean>("Vanilla", false));
    public Setting<Integer> stepHeight = this.add(new Setting<Integer>("Height", 2, 1, 2));
    public Setting<Boolean> turnOff = this.add(new Setting<Boolean>("Disable", false));
    private static Step instance;

    public Step() {
        super("Step", "Allows you to step up blocks", Category.MOVEMENT, true, false);
        instance = this;
    }
