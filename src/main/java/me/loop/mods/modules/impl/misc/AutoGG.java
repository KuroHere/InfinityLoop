...
public class AutoGG
    ...
    public Setting<String> custom = this.add(new Setting<String>("Custom", "InfinityHack"));
    public Setting<String> test = this.add(new Setting<String>("Test", "null"));
    private ConcurrentHashMap<String, Integer> targetedPlayers = null;

    public AutoGG() {
        super("AutoGG", "Sends msg after you kill someone", Category.MISC, true, false);
        this.setInstance();
    }
