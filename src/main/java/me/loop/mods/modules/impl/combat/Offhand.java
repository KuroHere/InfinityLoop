...
public class Offhand
    ...
    public Setting<Boolean> crystal = this.add(new Setting<Boolean>("Crystal", true));
    public Setting<Float> crystalHealth = this.add(new Setting<Float>("CrystalHP", Float.valueOf(13.0f), Float.valueOf(0.1f), Float.valueOf(36.0f)));
    public Setting<Float> crystalHoleHealth = this.add(new Setting<Float>("CrystalHoleHP", Float.valueOf(3.5f), Float.valueOf(0.1f), Float.valueOf(36.0f)));
    public Setting<Boolean> gapple = this.add(new Setting<Boolean>("Gapple", true));
    public Setting<Boolean> armorCheck = this.add(new Setting<Boolean>("ArmorCheck", true));
    public Setting<Integer> actions = this.add(new Setting<Integer>("Packets", 4, 1, 4));
    ...
    public Offhand() {
        super("Offhand", "Allows you to switch up your Offhand.", Category.COMBAT, true, false);
        instance = this;
    }
    ...
    @SubscribeEvent
    public void onUpdateWalkingPlayer(RightClickBlockEvent event) {
