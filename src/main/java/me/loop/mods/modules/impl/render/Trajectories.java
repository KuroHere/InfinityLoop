...
public class Trajectories extends Module {
    private final Setting<Float> lineWidth = this.add(new Setting<>("LineWidth", Float.valueOf(1.0f), Float.valueOf(0.1f), Float.valueOf(5.0f)));
    private final Setting<Float> red = this.add(new Setting<>("Red", Float.valueOf(0.0f), Float.valueOf(0.0f), Float.valueOf(255.0f)));
