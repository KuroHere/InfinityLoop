...
public class Skeleton
    ...
    public Skeleton() {
        super("Skeleton", "Draws a skeleton inside the player.", Category.RENDER);
    }
    ...
    private void drawSkeleton(Render3DEvent event, EntityPlayer e) {
        ...
        if (entPos != null && e.isEntityAlive() && !e.isDead && e != Skeleton.mc.player && !e.isPlayerSleeping()) {
            ...
            if (Managers.friendManager.isFriend(e.getName())) {
                ...
                GlStateManager.color((float) ClickGui.INSTANCE.moduleMainC.getPlannedValue().getRed() / 255.0f, (float) ClickGui.INSTANCE.moduleMainC.getPlannedValue().getGreen() / 255.0f, (float) ClickGui.INSTANCE.moduleMainC.getPlannedValue().getBlue() / 255.0f, (float) this.alpha.getValue().intValue());
            }
