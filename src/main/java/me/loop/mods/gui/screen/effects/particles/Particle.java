...
public class Particle {
    ...
    public void render(int mouseX, int mouseY) {
        ...
        if (Colors.getInstance().rainbow.getValue() && ClickGui.INSTANCE.colorSync.getValue()) {
            ...
            RenderUtil.drawRect(this.pos.x, this.pos.y, this.pos.x + this.size, this.pos.y + this.size, new Color(ClickGui.INSTANCE.moduleMainC.getValue().getRed(), ClickGui.INSTANCE.moduleMainC.getValue().getGreen(), ClickGui.INSTANCE.moduleMainC.getValue().getBlue()).getRGB());
        }
    }
