...
public class EnumButton
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Managers.textManager.drawStringWithShadow(this.setting.getName() + " \u00a77" + this.setting.currentEnumName(), this.x + 2.3f, this.y - 1.7f - (float) InfinityLoopGui.INSTANCE.getTextOffset(), this.getState() ? -1 : -5592406);
    }
