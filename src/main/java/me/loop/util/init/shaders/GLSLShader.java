package me.loop.util.init.shaders;
...
public class GLSLShader {
    ...
    public GLSLShader(String fragmentShaderLocation) throws IOException {
        ...
        glAttachShader(program, createShader("shaders/passthrough.vsh", GLSLShader.class.getResourceAsStream("shaders/passthrough.vsh"), GL_VERTEX_SHADER));
