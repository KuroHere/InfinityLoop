...
public class AutoArmor
    ...
    private final Setting<Boolean> curse = this.add(new Setting<Boolean>("Vanishing", false));
    private final Setting<Boolean> mendingTakeOff = this.add(new Setting<Boolean>("AutoMend", false));
    private final Setting<Integer> closestEnemy = this.add(new Setting<Object>("Enemy", Integer.valueOf(8), Integer.valueOf(1), Integer.valueOf(20), v -> this.mendingTakeOff.getValue()));
    private final Setting<Integer> repair = this.add(new Setting<Object>("Repair%", Integer.valueOf(80), Integer.valueOf(1), Integer.valueOf(100), v -> this.mendingTakeOff.getValue()));
    private final Setting<Integer> actions = this.add(new Setting<Integer>("Packets", 3, 1, 12));
