...
public class ESP
    ...
    private final Setting<Boolean> xporbs = this.add(new Setting<Boolean>("XpOrbs", false));
    private final Setting<Boolean> xpbottles = this.add(new Setting<Boolean>("XpBottles", false));
    private final Setting<Boolean> pearl = this.add(new Setting<Boolean>("Pearls", false));
    ...
    private final Setting<Integer> boxAlpha = this.add(new Setting<Integer>("BoxAlpha", 120, 0, 255));
    private final Setting<Integer> alpha = this.add(new Setting<Integer>("Alpha", 255, 0, 255));

    public ESP() {
        super("ESP", "Renders a nice ESP.", Category.RENDER, true, false, false);
        this.setInstance();
    }
