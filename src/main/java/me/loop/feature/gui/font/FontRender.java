package me.loop.feature.gui.font;
...
public class FontRender{
    ...
    public static float drawStringWithShadow(String text, int x, int y, int color) {
        if (isCustomFontEnabled())
            return Managers.fontRenderer.drawStringWithShadow(text, x, y, color);
    ...
    public static float drawString(String text, int x, int y, int color) {
        if (isCustomFontEnabled())
            return Managers.fontRenderer.drawString(text, x, y, color);
    ...
    public static int getStringWidth(String str) {
        if (isCustomFontEnabled())
            return Managers.fontRenderer.getStringWidth(str);

        return Util.mc.fontRenderer.getStringWidth(str);
    }

    public static int getStringWidth6(String str) {
        return Managers.fontRenderer6.getStringWidth(str);
    }

    public static int getStringWidth5(String str) {
        return Managers.fontRenderer5.getStringWidth(str);
    }

    public static int getStringWidth3(String str) {
        return Managers.fontRenderer3.getStringWidth(str);
    }


    public static int getStringWidth4(String str) {
        return Managers.fontRenderer4.getStringWidth(str);
    }

    public static int getFontHeight() {
        if (isCustomFontEnabled())
            return Managers.fontRenderer.getHeight() + 2;
    ...
    public static int getFontHeight2() {
        if (isCustomFontEnabled())
            return Managers.fontRenderer4.getHeight() + 2;
    ...
    public static int getFontHeight3() {
        if (isCustomFontEnabled())
            return Managers.fontRenderer3.getHeight();

        return Util.mc.fontRenderer.FONT_HEIGHT;
    }

    public static int getFontHeight6() {
        return Managers.fontRenderer6.getHeight();
    }

    public static int getFontHeight8() {
        return Managers.fontRenderer8.getHeight();
    }

    public static int getFontHeight5() {
        return Managers.fontRenderer5.getHeight() + 2;
    }
