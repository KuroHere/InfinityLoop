package me.loop.feature.gui.click;
...
import me.loop.feature.gui.click.items.buttons.Button;
...
import static me.loop.feature.modules.impl.client.ClickGui.ClickGui.getInstance;
...
public abstract class Component
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (getInstance().isEnabled()); {
            ...
            RenderUtil.drawBorderedRect(this.x + 0.4, (float) this.y + 12.5f + 0.1 - 13, this.x + this.width + 0.1, (float) (this.y + this.height) + totalItemHeight + 0.5, ClickGui.getInstance().getOutlineWidth() - ClickGui.getInstance().getOutlineWidth() * 2, new Color(0, 0, 0, 0).getRGB(), new Color(ClickGui.getInstance().moduleMainC.getValue().getRed(), ClickGui.getInstance().moduleMainC.getValue().getGreen(), ClickGui.getInstance().moduleMainC.getValue().getBlue(), getInstance().moduleMainC.getValue().getAlpha()).getRGB());
        }
        if (!this.open)  {
