...
import me.loop.features.setting.EnumConverter;
...
public class ModuleCommand
    ...
    public static void setCommandValue(Feature mod, Setting setting, JsonElement element) {
        String str;
        for(Setting setting2 : mod.getSettings()) {
