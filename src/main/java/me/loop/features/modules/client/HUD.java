...
public class HUD extends Module {
    ...
    public void onRender2D(Render2DEvent event) {
        ...
        this.color = ColorUtil.toRGBA((Colors.getInstance()).c.getValue().getRed(), (Colors.getInstance()).c.getValue().getGreen(), (Colors.getInstance()).c.getValue().getBlue());
    ...
    public void onLoad() {
        InfinityLoop.commandManager.setClientMessage(getCommandMessage());
    }
