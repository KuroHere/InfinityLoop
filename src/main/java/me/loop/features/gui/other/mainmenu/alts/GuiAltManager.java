...
import me.loop.features.gui.click.items.buttons.StringButton;
import me.loop.features.gui.font.FontRender;
import me.loop.features.gui.other.mainmenu.GuiMainMenuButton;
import me.loop.features.gui.other.mainmenu.InfinityLoopMenu;
import me.loop.features.gui.other.mainmenu.MainMenuShader;
import me.loop.features.modules.client.MainSettings;
import me.loop.util.LoopUtil;
    ...
    public void keyTyped(char chr, int keyCode) {
        if (listening) {
            switch (keyCode) {
                ...
                case 14: {
                    add_name = StringButton.removeLastChar(add_name);
                }
            }
