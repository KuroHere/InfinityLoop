...
import me.loop.features.setting.Bind;
...
public class ModuleButton
        ...
        if (!this.items.isEmpty()) {
            ...
            if (this.isHovering(mouseX, mouseY)) {
                ...
                if (follow) {
                    ...
                    Description descriptionDisplay = InfinityLoopGui.getClickGui().getDescription();
    ...
    public void drawGear() {
        boolean future = ClickGui.getInstance().setting.getValue() == ClickEnum.Style.Future;
        boolean chart = ClickGui.getInstance().butonIcon.getValue() == ClickEnum.Style.OpenColse;
        boolean bind = ClickGui.getInstance().butonIcon.getValue() == ClickEnum.Style.ShowBind;
