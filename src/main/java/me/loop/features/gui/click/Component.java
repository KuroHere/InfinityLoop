package me.loop.features.gui.click;
...
import me.loop.features.gui.click.items.buttons.Button;
...
import me.loop.util.impl.ImageUtil;
...
public abstract class Component
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        boolean future = ClickGui.getInstance().moduleiconmode.getValue();
        ...
        if (ClickGui.getInstance().isOn()); {
            ...
            RenderUtil.drawBorderedRect(this.x + 0.4, (float) this.y + 12.5f + 0.1 - 13, this.x + this.width + 0.1, (float) (this.y + this.height) + totalItemHeight + 0.5, ClickGui.getInstance().getOutlineWidth() - ClickGui.getInstance().getOutlineWidth() * 2, new Color(0, 0, 0, 0).getRGB(), new Color(ClickGui.getInstance().moduleMainC.getValue().getRed(), ClickGui.getInstance().moduleMainC.getValue().getGreen(), ClickGui.getInstance().moduleMainC.getValue().getBlue(), ClickGui.getInstance().moduleMainC.getValue().getAlpha()).getRGB());
        }
        if (!this.open)  {
            RenderUtil.drawBorderedRect(this.x, (float)this.y - 1.5f, this.x + this.width, this.y + this.height - 6, ClickGui.getInstance().getOutlineWidth() - ClickGui.getInstance().getOutlineWidth()*2, new Color(0,0,0,0).getRGB(), new Color(ClickGui.getInstance().moduleMainC.getValue().getRed(), ClickGui.getInstance().moduleMainC.getValue().getGreen(), ClickGui.getInstance().moduleMainC.getValue().getBlue(), ClickGui.getInstance().moduleMainC.getValue().getAlpha()).getRGB());
        }
        ...
        if (ClickGui.getInstance().categoryTextCenter.getValue().booleanValue()) {
            InfinityLoop.textManager.drawStringWithShadow(this.getName(), (float)this.x + (float)(this.width / 2) - (float)(this.renderer.getStringWidth(this.getName()) / 2), (float)this.y - 4.0f - (float)InfinityLoopGui.getClickGui().getTextOffset(), -1);
        } else {
            InfinityLoop.textManager.drawStringWithShadow(this.getName(), (float)this.x + 3.0f, (float)this.y - 4.0f - (float)InfinityLoopGui.getClickGui().getTextOffset(), -1);
        }
