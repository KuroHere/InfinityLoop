...
public class BooleanButton
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        InfinityLoop.textManager.drawStringWithShadow(this.getName(), this.x + 2.3f, this.y - 1.7f - (float) InfinityLoopGui.getClickGui().getTextOffset(), this.getState() ? -1 : -5592406);
    }
