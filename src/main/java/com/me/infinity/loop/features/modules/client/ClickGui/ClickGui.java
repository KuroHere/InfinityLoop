package com.me.infinity.loop.features.modules.client.ClickGui;
...
public class ClickGui
    ...
    public Setting<Enum> description = this.register(new Setting("Description", ClickguiEnum.Mode.Frame));
    ...
    public Setting<Enum> butonIcon = register(new Setting("ButtonIcon", ClickguiEnum.Icon.OpenColse));
    public Setting<String> open = register(new Setting("Open: ", "+", v -> this.butonIcon.getValue() == ClickguiEnum.Icon.OpenColse).setRenderName(true));
    public Setting<String> close = register(new Setting("Close: ", "-", v -> this.butonIcon.getValue() == ClickguiEnum.Icon.OpenColse).setRenderName(true));
