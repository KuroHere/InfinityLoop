...
import com.me.infinity.loop.util.utils.openGL.ShaderUtility;
...
public class ShaderESP extends Module {
    ...
    private final ShaderUtility glowShader = new ShaderUtility("loop/shaders/glow.frag");

    private final Frustum frustum = new Frustum();

    private final ShaderUtility outlineShader = new ShaderUtility("loop/shaders/outline.frag");
