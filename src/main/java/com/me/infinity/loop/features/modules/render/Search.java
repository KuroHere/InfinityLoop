...
import com.me.infinity.loop.event.events.render.EventBlockRender;
import com.me.infinity.loop.event.events.render.Render3DEvent;
import com.me.infinity.loop.features.modules.Module;
import com.me.infinity.loop.features.modules.ModuleCategory;
import com.me.infinity.loop.features.setting.Setting;
import com.me.infinity.loop.mixin.mixins.IEntityRenderer;
import com.me.infinity.loop.mixin.mixins.IRenderManager;
import com.me.infinity.loop.util.utils.renders.TessellatorUtil;
...
public class Search extends Module {
    ...
    public Search() {
        super("Search", "Find a block", ModuleCategory.RENDER);
    }
    ...
    private  Setting<Color> color = this.register( new Setting<>("Color", new Color(0xFF00FFFF)));
    ...
    @SubscribeEvent
    public void onBlockRender(EventBlockRender event) {
