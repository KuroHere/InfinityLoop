...
import com.me.infinity.loop.event.events.player.EventEntityMove;
import com.me.infinity.loop.event.events.render.PreRenderEvent;
import com.me.infinity.loop.event.events.render.Render3DEvent;
import com.me.infinity.loop.features.modules.Module;
import com.me.infinity.loop.features.modules.ModuleCategory;
import com.me.infinity.loop.features.setting.Setting;
import com.me.infinity.loop.util.utils.maths.AstolfoAnimation;
...
public class PlayerTrails extends Module {
    ...
    private final Setting<Color> color = this.register(new Setting<>("Color", new Color(0x8800FF00)));
    Map<EntityPlayer, List<Trail> > entAndTrail = new HashMap<>();

    public PlayerTrails() {
        super("PlayerTrails", "Render Line Behind U", ModuleCategory.RENDER);
    }
