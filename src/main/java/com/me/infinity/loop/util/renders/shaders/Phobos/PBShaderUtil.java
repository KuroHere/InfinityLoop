package com.me.infinity.loop.util.renders.shaders.Phobos;
...
public class PBShaderUtil {

    private final int programID;

    public PBShaderUtil(String fragmentShaderLoc, String vertexShaderLoc) {
        ...
        try {
            ...
            switch (fragmentShaderLoc) {
                ...
                default:
                    fragmentShaderID = createShader(
                            Util.mc.getResourceManager().getResource(new ResourceLocation(fragmentShaderLoc))
            ...
            int vertexShaderID = createShader(
                    Util.mc.getResourceManager().getResource(new ResourceLocation(vertexShaderLoc)).getInputStream(),
                    GL_VERTEX_SHADER);
    ...
    public PBShaderUtil(String fragmentShaderLoc) {
